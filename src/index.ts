 ...
 * reads and its guarded deletions under `/api/dsh-hypatia`, and optionally
...
export type {
  BatchDeleteOutcome, BatchDeleteRequest, BatchDeleteResponse, BatchDeleteStatus,
